...
while i < nbrLines:
    ...
    while z < nbrColumn:
        ...
        cv.rectangle(thresholdMap,(testBlock[1][0][0],testBlock[1][0][1]),(testBlock[1][1][0],testBlock[1][1][1]),(tempBlueVal,tempBlueVal,tempBlueVal),-1)
        z = z+1
    i = i+1
